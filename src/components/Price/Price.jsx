...
const Price = () => {
    ...
    const [obViezd, setObViezd] = useState([
        { id: 1, title: 'Выездное ослуживание/ремонт оборудования (включает в себя выезд, диагностику, устранение неисправности, настройку)', price: 'Первый час 1000р последующий 500' },
