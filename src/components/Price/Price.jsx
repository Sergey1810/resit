...
const Price = () => {
    ...
    const [techBook, setTechBook] = useState([
        ...
        { id: 8, title: 'Замена разъёма питания/видео/аудио и другие', price: 'от 700' },
    ...
    const [obViezd, setObViezd] = useState([
        ...
        { id: 7, title: 'Обжим кабеля витая пара (rg-45/rg-12) цена за обжим одного конца', price: 'от 50' },
    ...
    const [mfy, setMfy] = useState([
        { id: 1, title: 'Лазерный принтер, чб, А4/A3', price: 'от 350/700' },
        { id: 3, title: 'Лазерный принтер, (цвет), А4/A3', price: 'от 500/1000' },
        { id: 5, title: 'Копировальный аппарат, А4/A3', price: 'от 350/500' },
        { id: 7, title: 'МФУ лазерный, чб, А4/A3', price: 'от 500/1000' },
        { id: 9, title: 'МФУ лазерный, (цвет), А4/A3', price: 'от 700/2000' },
        { id: 11, title: 'Запуск в эксплуатацию принтера, МФУ', price: 'от 700' },
        { id: 13, title: 'Прошивка принтера, МФУ', price: 'от 1500' },
        { id: 14, title: 'Диагностика принтера, МФУ', price: 'от 500' },

    ])
    const [cs, setCs] = useState([
        { id: 1, title: 'Удалённая помощь', price: 'от 1200' },
    ...
    const [remPr, setRemPr] = useState([
        { id: 1, title: 'Диагностика неисправности/ремонт монитора', price: 'от 350/1200' },
        ...
        { id: 9, title: 'Замена разъёма/ремонт платы смартфона', price: 'от 1000' },
        { id: 10, title: 'Защита гаджетов гидрогелевой плёнкой', price: 'от 700' },
