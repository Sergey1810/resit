...
const Problem = () => {
    ...
    const problem = [
        {
            id: 1, title: 'Как я могу связаться с вами для консультации?', lable: 'Вы можете позвонить нам по телефону. Мы свяжемся с вами для уточнения всех деталей.'
        },
        {
        ...
        {
            id: 4, title: '  Можно ли принести свою запчасть?', lable: 'Да, вы можете принести свою запчасть, если она подходит по техническим характеристикам. Однако мы не даём гарантию на ваши детали.'
        },
        {
        ...
        {
            id: 6, title: 'Какие документы я получу после ремонта?', lable: 'После завершения ремонта вы получите акт выполненных работ и гарантийный талон на наши работы.'
        },
        {
            id: 7, title: ' Как я могу оплатить ремонт?', lable: ' Вы можете оплатить ремонт наличными или через платежные системы (СБП).'
        },
