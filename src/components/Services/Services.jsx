...
const Services = () => {
    ...
    const mapService1 = [
        ...
        { id: 11, title: 'Замена разъёмов', price: '700р' },
    ...
    const mapService2 = [
        ...
        { id: 8, title: 'Замена разъёма питания/видео/аудио и другие', price: '700р' },
    ...
    const mapService4 = [
        ...
        { id: 10, title: 'Удалённая помощь', price: '1200р' },
    ...
    const mapService5 = [
        ...
        { id: 10, title: 'Гидрогелевая плёнка для телефона', price: '700р' },
